...
// let cross = true;
// let gameOver = false;
// let gameSpeed = 100; // Adjust the game speed here (lower value = faster game)
...
//     if (e.keyCode === 32 && !gameOver) { // Space key to jump
...
//         if (offsetX < 73 && offsetY < 52) {
//             gameOverElement.innerHTML = "Game Over - Press any key to restart";
//             obstacle.classList.remove('obstacleAni');
//             audiogo.play();
//             setTimeout(() => {
//                 audiogo.pause();
